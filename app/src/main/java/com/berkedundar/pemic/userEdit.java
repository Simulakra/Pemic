    ...
    private void FloatingListeners() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    if (userMAC.equals("")) {
                        new JSONTask(userEdit.this).execute(new Statics().ADD_NEW_USER, "MAC", mac, "Nickname", temp).get();
                    } else {
                        new JSONTask(userEdit.this).execute(new Statics().EDIT_ONE_USER, "MAC", mac, "Nickname", temp, "old_mac", userMAC).get();
                    }
                }catch (Exception e) {
